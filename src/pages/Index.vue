  ...
  <form class="container mx-auto flex flex-col gap-3">
    ...
    <stat-section title="State:">
      ...
      <div class="flex flex-col">
        ...
        <textarea class="w-full h-auto grow resize-none" name="equipment_and_inventory" id="equipment_and_inventory" v-model="characterSheet.equipmentAndInventory"></textarea>
      </div>
      <div class="flex flex-col">
...
export default {
  ...
  mounted() {
    ...
    cachedSheet = JSON.parse(cachedSheet && cachedSheet !== '[object Object]' ? cachedSheet : '{}');

    if(JSON.stringify(cachedSheet) !== '{}') {
      console.log(cachedSheet);
